...
def admin_dashboard(request):
    # Your code here, such as fetching data for the admin dashboard
    return render(request, 'railway/admin_dashboard.html')  # Adjust template name if needed
...
,
                    ...
                    payment_amount=payment_amount + Decimal(total_fare)+Decimal(number_of_tickets),
